...
import mods.timaxa007.pack.furniture.common.blocks.BlockGroundBlocks;
...
public class ItemRenderBlockGroundBlocks implements IItemRenderer {
	...
	public void renderItem(ItemRenderType type, ItemStack is, Object... data) {
		...
		Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("timaxa007", "textures/blocks/ground/" + BlockGroundBlocks.type_block[tex] + "_overlay.png"));
