...
import mods.timaxa007.pack.furniture.common.blocks.BlockClothBlocks;
...
public class ItemRenderBlockClothBlocks implements IItemRenderer {
	...
	public void renderItem(ItemRenderType type, ItemStack is, Object... data) {
		...
		Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("timaxa007", "textures/blocks/cloth/" + BlockClothBlocks.type_block[tex] + "_overlay.png"));
