...
import mods.timaxa007.pack.furniture.common.blocks.BlockWoodBlocks;
...
public class ItemRenderBlockWoodBlocks implements IItemRenderer {
	...
	public void renderItem(ItemRenderType type, ItemStack is, Object... data) {
		...
		Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("timaxa007", "textures/blocks/wood/" + BlockWoodBlocks.type_block[tex] + "_overlay.png"));
