...
import mods.timaxa007.pack.furniture.common.blocks.BlockMetalBlocks;
...
public class ItemRenderBlockMetalBlocks implements IItemRenderer {
	...
	public void renderItem(ItemRenderType type, ItemStack is, Object... data) {
		...
		Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("timaxa007", "textures/blocks/metal/" + BlockMetalBlocks.type_block[tex] + "_overlay.png"));
