...
import mods.timaxa007.pack.furniture.common.blocks.BlockRockBlocks;
...
public class ItemRenderBlockRockBlocks implements IItemRenderer {
	...
	public void renderItem(ItemRenderType type, ItemStack is, Object... data) {
		...
		Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("timaxa007", "textures/blocks/stone/" + BlockRockBlocks.type_block[tex] + "_overlay.png"));
