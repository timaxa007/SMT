package mods.timaxa007.pack.furniture.client.render.model;
...
public class ModelMask extends ModelBiped {
	...
	private static ModelRenderer armor;
	...
	public ModelMask(int i) {
		...
		if (i == 3) {
			model = AdvancedModelLoader.loadModel(new ResourceLocation("timaxa007", "obj/jar01.obj"));
		}
