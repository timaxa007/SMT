...
import mods.timaxa007.pack.furniture.common.tile.TEWardrobe;
...
public class BlockRenderWardrobe extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity te, double dx, double dy, double dz, float f) {
		renderTE((TEWardrobe)te, dx, dy, dz, f);
	}

	private void renderTE(TEWardrobe te, double dx, double dy, double dz, float f) {
		int tex = te.getType();
