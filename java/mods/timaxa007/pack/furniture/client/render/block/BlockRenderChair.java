...
import mods.timaxa007.pack.furniture.common.tile.TEChair;
...
public class BlockRenderChair extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity te, double dx, double dy, double dz, float f) {
		renderTE((TEChair)te, dx, dy, dz, f);
	}

	private void renderTE(TEChair te, double dx, double dy, double dz, float f) {
