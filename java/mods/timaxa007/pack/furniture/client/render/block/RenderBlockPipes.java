...
import mods.timaxa007.pack.furniture.common.tile.TEPipes;
...
public class RenderBlockPipes extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity te, double dx, double dy, double dz, float f) {
		renderTE((TEPipes)te, dx, dy, dz, f);
	}

	private void renderTE(TEPipes te, double dx, double dy, double dz, float f) {
