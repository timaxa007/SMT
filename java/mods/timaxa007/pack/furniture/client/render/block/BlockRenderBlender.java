...
import mods.timaxa007.pack.furniture.common.tile.TEBlender;
...
public class BlockRenderBlender extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity te, double dx, double dy, double dz, float f) {
		renderTE((TEBlender)te, dx, dy, dz, f);
	}

	private void renderTE(TEBlender te, double dx, double dy, double dz, float f) {
