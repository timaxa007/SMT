...
public class ListBlock {
	...
	public static Block fluid_fake_water;
	public static Block fluid_fake_water_flowing;
	public static Block fluid_fake_lava;
	public static Block fluid_fake_lava_flowing;
	...
	public static void preInit() {
		...
		fluid_fake_water = new BlockFluidFakeWaterStatic().setLightOpacity(3).setBlockName("fluid_fake_water").setBlockTextureName("water_still");
		fluid_fake_water_flowing = new BlockFluidFakeWaterDynamic().setLightOpacity(3).setBlockName("fluid_fake_water_flowing").setBlockTextureName("water_flow");
		fluid_fake_lava = new BlockFluidFakeLavaStatic().setLightLevel(1.0F).setBlockName("fluid_fake_lava").setBlockTextureName("lava_still");
		fluid_fake_lava_flowing = new BlockFluidFakeLavaDynamic().setLightLevel(1.0F).setBlockName("fluid_fake_lava_flowing").setBlockTextureName("lava_flow");
		...
		GameRegistry.registerBlock(fluid_fake_water, "BlockFluidFakeWaterStatic");
		GameRegistry.registerBlock(fluid_fake_water_flowing, "BlockFluidFakeWaterDynamic");
		GameRegistry.registerBlock(fluid_fake_lava, "BlockFluidFakeLavaStatic");
		GameRegistry.registerBlock(fluid_fake_lava_flowing, "BlockFluidFakeLavaDynamic");
