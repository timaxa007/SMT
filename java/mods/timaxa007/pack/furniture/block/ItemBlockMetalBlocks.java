...
public class ItemBlockMetalBlocks extends ItemBlock {

	public ItemBlockMetalBlocks(Block id) {
		super(id);
	}
	...
	public String getUnlocalizedName(ItemStack is) {
		...
		if (tag != null && tag.hasKey("SubID")) {
			return super.getUnlocalizedName() + "." + BlockMetalBlocks.type_block[tag.getByte("SubID")];
		}
