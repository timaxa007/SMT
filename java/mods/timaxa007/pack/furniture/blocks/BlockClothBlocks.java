...
@Override
public TileEntity createNewTileEntity(World world, int meta) {return new TEBlockClothBlocks();}
...
if (te != null && te instanceof TEBlockClothBlocks) {
return addTag(world.getBlock(x, y, z), ((TEBlockClothBlocks)te).getSubID(), ((TEBlockClothBlocks)te).getColorBlock());
} else {
...
dropBlockAsItem(world, x, y, z, addTag(world.getBlock(x, y, z), ((TEBlockClothBlocks)te).getSubID(), ((TEBlockClothBlocks)te).getColorBlock()));
...
((TEBlockClothBlocks)te).setColorBlock(GetColors.getColorMix(ItemDye.field_150922_c[current.getItemDamage()], ((TEBlockClothBlocks)te).getColorBlock()));
//world.scheduleBlockUpdate(x, y, z, world.getBlock(x, y, z), 4);
return true;
}
//--------------------------------
