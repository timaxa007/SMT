...
world.setBlock(par2, par3, par4, PackFurniture.proxy.block_model_lamps_off_invert, j, 2);
}
}
...
for(byte j=0;j<16;++j) {
if(getDamageValue(world, par2, par3, par4)==j) {
world.setBlock(par2, par3, par4, PackFurniture.proxy.block_model_lamps_on_invert, j, 2);
}
}
