...
if (current != null) {
//--------------------------------
if ((current.getItem() == Items.flint_and_steel) && (world.getBlock(x, y, z) == PackFurniture.proxy.block_bonfires)) {
world.setBlock(x, y, z, PackFurniture.proxy.block_bonfires_burning);
