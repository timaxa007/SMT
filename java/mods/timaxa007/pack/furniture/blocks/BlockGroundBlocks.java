...
@Override
public TileEntity createNewTileEntity(World world, int meta) {return new TEBlockGroundBlocks();}
...
if (te != null && te instanceof TEBlockGroundBlocks) {
return addTag(world.getBlock(x, y, z), ((TEBlockGroundBlocks)te).getSubID(), ((TEBlockGroundBlocks)te).getColorBlock());
} else {
...
dropBlockAsItem(world, x, y, z, addTag(world.getBlock(x, y, z), ((TEBlockGroundBlocks)te).getSubID(), ((TEBlockGroundBlocks)te).getColorBlock()));
...
((TEBlockGroundBlocks)te).setColorBlock(GetColors.getColorMix(ItemDye.field_150922_c[current.getItemDamage()], ((TEBlockGroundBlocks)te).getColorBlock()));
//world.scheduleBlockUpdate(x, y, z, world.getBlock(x, y, z), 4);
return true;
}
//--------------------------------
