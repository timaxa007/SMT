...
public class BlockModelLampsOffInvert extends BlockContainer{
@SideOnly(Side.CLIENT) private IIcon[] iconArray;
private final boolean powered;

public BlockModelLampsOffInvert() {
...
setBlockName("BlockModelLampsOffInvert");
}
/*
...
@Override
public TileEntity createNewTileEntity(World world, int meta) {return new TELampsOff();}
...
par1World.setBlock(par2, par3, par4, PackFurniture.proxy.block_model_lamps_off_invert, j, 2);
}
}
...
for(byte j=0;j<16;++j) {
if(getDamageValue(par1World, par2, par3, par4)==j) {
par1World.setBlock(par2, par3, par4, PackFurniture.proxy.block_model_lamps_on_invert, j, 2);
}
}
...
ret.add(new ItemStack(PackFurniture.proxy.block_model_lamps_on_invert, 1, metadata));
return ret;
}
*/
@SideOnly(Side.CLIENT)
