	...
	public static void list() {
		...
		for (int i = 1; i < 16; ++i) {
			GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wool, 1, GetColors.convertME_MC(i)), new Object[] {
				new ItemStack(PackFurniture.proxy.item_colored, 1, i), new ItemStack(Blocks.wool, 1, 0)});
		}
		//white+black=gray;
		GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wool, 1, 7), new Object[] {
			new ItemStack(PackFurniture.proxy.item_colored, 1, 0), new ItemStack(Blocks.wool, 1, 0)});
		//gray+black=black;
		GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wool, 1, 15), new Object[] {
			new ItemStack(PackFurniture.proxy.item_colored, 1, 0), new ItemStack(Blocks.wool, 1, 7)});
		//black+white=LightGray;
		GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wool, 1, 8), new Object[] {
			new ItemStack(PackFurniture.proxy.item_colored, 1, 14), new ItemStack(Blocks.wool, 1, 15)});
		//LightGray+white=white;
		GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wool, 1, 0), new Object[] {
			new ItemStack(PackFurniture.proxy.item_colored, 1, 14), new ItemStack(Blocks.wool, 1, 8)});
		//black+LightGray=gray;
		GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wool, 1, 7), new Object[] {
			new ItemStack(PackFurniture.proxy.item_colored, 1, 13), new ItemStack(Blocks.wool, 1, 15)});
		//gray+white=LightGray;
		GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wool, 1, 8), new Object[] {
			new ItemStack(PackFurniture.proxy.item_colored, 1, 14), new ItemStack(Blocks.wool, 1, 7)});
		//white+black+black=black;
		GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wool, 1, 15), new Object[] {
			new ItemStack(PackFurniture.proxy.item_colored, 1, 0), new ItemStack(PackFurniture.proxy.item_colored, 1, 0), new ItemStack(Blocks.wool, 1, 0)});
		//white+black+gray=black;
		GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wool, 1, 15), new Object[] {
			new ItemStack(PackFurniture.proxy.item_colored, 1, 4), new ItemStack(PackFurniture.proxy.item_colored, 1, 0), new ItemStack(Blocks.wool, 1, 0)});
		/*
		for (byte i = 0; i < 16; ++i) {
		GameRegistry.addRecipe(new ItemStack(PackFurniture.proxy.block_lamps_click_off, 1, i), new Object[] {"GGG", "LXL", "GPG", 'G', Blocks.glass, 'L', Items.glowstone, 'P', Blocks.lever, 'X', new ItemStack(PackFurniture.proxy.item_colored, 1, i)});
		GameRegistry.addRecipe(new ItemStack(PackFurniture.proxy.block_lamps_off, 1, i), new Object[] {"GGG", "LXL", "GPG", 'G', Blocks.glass, 'L', Items.glowstone, 'P', Items.redstone, 'X', new ItemStack(PackFurniture.proxy.item_colored, 1, i)});
		GameRegistry.addRecipe(new ItemStack(PackFurniture.proxy.block_lamps_on_invert, 1, i), new Object[] {"GGG", "LXL", "GPG", 'G', Blocks.glass, 'L', Items.glowstone, 'P', Blocks.torchRedstoneActive, 'X', new ItemStack(PackFurniture.proxy.item_colored, 1, i)});

		GameRegistry.addRecipe(new ItemStack(PackFurniture.proxy.block_lamps_click_off, 1, i), new Object[] {"GGG", "LXL", "GPG", 'G', Blocks.glass, 'L', Items.glowstone, 'P', Blocks.lever, 'X', new ItemStack(Items.dyePowder, 1, GetColors.convertME_MCitem(i))});
		GameRegistry.addRecipe(new ItemStack(PackFurniture.proxy.block_lamps_off, 1, i), new Object[] {"GGG", "LXL", "GPG", 'G', Blocks.glass, 'L', Items.glowstone, 'P', Items.redstone, 'X', new ItemStack(Items.dyePowder, 1, GetColors.convertME_MCitem(i))});
		GameRegistry.addRecipe(new ItemStack(PackFurniture.proxy.block_lamps_on_invert, 1, i), new Object[] {"GGG", "LXL", "GPG", 'G', Blocks.glass, 'L', Items.glowstone, 'P', Blocks.torchRedstoneActive, 'X', new ItemStack(Items.dyePowder, 1, GetColors.convertME_MCitem(i))});
		}
		 */
		/*
		for (byte i = 0; i < 16; ++i) {
