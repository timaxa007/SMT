...
public class ItemBlockRockBlocks extends ItemBlock {

public ItemBlockRockBlocks(Block id) {
super(id);
}
...
return super.getUnlocalizedName() + "." + BlockRockBlocks.type_block[tag.getByte("SubID")];
}
