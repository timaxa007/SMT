...
public class ItemBlockGroundBlocks extends ItemBlock {

	public ItemBlockGroundBlocks(Block id) {
		super(id);
	}
	...
	public String getUnlocalizedName(ItemStack is) {
		...
		if (tag != null && tag.hasKey("SubID")) {
			return super.getUnlocalizedName() + "." + BlockGroundBlocks.type_block[tag.getByte("SubID")];
		}
