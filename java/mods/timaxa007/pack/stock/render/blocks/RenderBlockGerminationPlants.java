...
public class RenderBlockGerminationPlants extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity te, double dx, double dy, double dz, float f) {
		renderTileEntity((TileEntityGerminationPlants)te, dx, dy, dz, f);
	}

	private void renderTileEntity(TileEntityGerminationPlants te, double dx, double dy, double dz, float f) {
		int plant_id = 0;
		String plant_type = "";
		int width = 0;
		int height = 0;
		...
		GL11.glPopMatrix();
		//------------------------------------------------------------------------------------------------------
		if (GerminationPlants.list[plant_id].getType() == "Crop" || GerminationPlants.list[plant_id].getType() == "Mushroom") {
			GL11.glPushMatrix();
			...
			if (plant_id != 0) {
				bindTexture(new ResourceLocation("timaxa007", 
						"textures/blocks/germination/" + 
								...
								GerminationPlants.list[plant_id].getTexture().toLowerCase() + "_" + height + ".png"));
			} else {
		...
		//------------------------------------------------------------------------------------------------------
		if (GerminationPlants.list[plant_id].getType() == "Tree") {
			...
			bindTexture(new ResourceLocation("timaxa007", "textures/blocks/log_" + GerminationPlants.list[plant_id].getTexture()));
