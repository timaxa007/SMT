...
public class Spinach {
	...
	public static GerminationPlants crop_spinach = new GerminationPlants("crop_spinach").setName("spinach").setType("Crop").setTexture("spinach").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
