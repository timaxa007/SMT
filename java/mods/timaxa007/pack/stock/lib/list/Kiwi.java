...
public class Kiwi {
	...
	public static GerminationPlants shrub_kiwi = new GerminationPlants("shrub_kiwi").setName("kiwi").setType("Shrub").setTexture("kiwi").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
