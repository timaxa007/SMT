...
public class Papaya {
	...
	public static GerminationPlants tree_papaya = new GerminationPlants("tree_papaya").setName("papaya").setType("Tree").setTexture("papaya").setPlantStats(1, 2, 3).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
