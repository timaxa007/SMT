...
public class Bean {
	...
	public static GerminationPlants crop_bean = new GerminationPlants("crop_bean").setName("bean").setType("Crop").setTexture("bean").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
