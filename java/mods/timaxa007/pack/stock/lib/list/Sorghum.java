...
public class Sorghum {

	public static GerminationPlants crop_sorghum = new GerminationPlants("crop_sorghum").setName("sorghum").setType("Crop").setTexture("sorghum").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
