...
public class Rice {
	...
	public static GerminationPlants crop_rice = new GerminationPlants("crop_rice").setName("rice").setType("Crop").setTexture("rice").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
