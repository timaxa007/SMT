...
public class Gooseberry {
	...
	public static GerminationPlants shrub_gooseberry = new GerminationPlants("shrub_gooseberry").setName("gooseberry").setType("Shrub").setTexture("gooseberry").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
