...
public class Radish {
	...
	public static GerminationPlants crop_radish = new GerminationPlants("crop_radish").setName("radish").setType("Crop").setTexture("radish").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
