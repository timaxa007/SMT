...
public class Pomegranate {
	...
	public static GerminationPlants tree_pomegranate = new GerminationPlants("tree_pomegranate").setName("pomegranate").setType("Tree").setTexture("pomegranate").setPlantStats(1, 2, 3).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
