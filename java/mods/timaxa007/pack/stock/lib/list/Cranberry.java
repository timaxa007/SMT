...
public class Cranberry {
	...
	public static GerminationPlants shrub_cranberry = new GerminationPlants("shrub_cranberry").setName("cranberry").setType("Shrub").setTexture("cranberry").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
