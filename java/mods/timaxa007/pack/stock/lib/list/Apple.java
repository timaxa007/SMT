...
public class Apple {
	...
	public static GerminationPlants tree_apple = new GerminationPlants("tree_apple").setName("apple").setType("Tree").setTexture("apple").setPlantStats(1, 2, 3).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
