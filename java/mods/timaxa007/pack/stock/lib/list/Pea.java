...
public class Pea {
	...
	public static GerminationPlants crop_pea = new GerminationPlants("crop_pea").setName("pea").setType("Crop").setTexture("pea").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
