...
public class Peach {
	...
	public static GerminationPlants tree_peach = new GerminationPlants("tree_peach").setName("plum").setType("Tree").setTexture("plum").setPlantStats(1, 2, 3).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
