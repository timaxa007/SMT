...
public class Ginger {
	...
	public static GerminationPlants crop_ginger = new GerminationPlants("crop_ginger").setName("ginger").setType("Crop").setTexture("ginger").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
