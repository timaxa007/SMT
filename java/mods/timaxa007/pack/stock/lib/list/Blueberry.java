...
public class Blueberry {
	...
	public static GerminationPlants herbal_blueberry = new GerminationPlants("herbal_blueberry").setName("blueberry").setType("Herbal").setTexture("blueberry").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
