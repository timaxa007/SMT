...
public class Barley {
	...
	public static GerminationPlants crop_barley = new GerminationPlants("crop_barley").setName("barley").setType("Crop").setTexture("barley").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
