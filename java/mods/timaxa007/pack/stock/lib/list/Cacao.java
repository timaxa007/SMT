...
public class Cacao {
	...
	public static GerminationPlants tree_cacao = new GerminationPlants("tree_cacao").setName("cacao").setType("Tree").setTexture("cacao").setPlantStats(1, 2, 3).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
