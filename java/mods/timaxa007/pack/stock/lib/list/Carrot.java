...
public class Carrot {
	...
	public static GerminationPlants crop_carrot = new GerminationPlants("crop_carrot").setName("carrot").setType("Crop").setTexture("carrot").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
