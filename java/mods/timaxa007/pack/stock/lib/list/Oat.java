...
public class Oat {
	...
	public static GerminationPlants crop_oat = new GerminationPlants("crop_oat").setName("oat").setType("Crop").setTexture("oat").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
