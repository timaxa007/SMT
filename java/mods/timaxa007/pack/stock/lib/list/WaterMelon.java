...
public class WaterMelon {
	...
	public static GerminationPlants squash_water_melon = new GerminationPlants("squash_water_melon").setName("water_melon").setType("Squash").setTexture("water_melon").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
