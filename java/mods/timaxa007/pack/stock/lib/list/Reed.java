...
public class Reed {
	...
	public static GerminationPlants crop_reed = new GerminationPlants("crop_reed").setName("reed").setType("Crop").setTexture("reed").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
