...
public class Celery {
	...
	public static GerminationPlants crop_celery = new GerminationPlants("crop_celery").setName("celery").setType("Crop").setTexture("celery").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
