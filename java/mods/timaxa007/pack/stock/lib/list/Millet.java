...
public class Millet {
	...
	public static GerminationPlants crop_millet = new GerminationPlants("crop_millet").setName("millet").setType("Crop").setTexture("millet").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
