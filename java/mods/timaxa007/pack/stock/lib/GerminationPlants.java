...
public class GerminationPlants {
	...
	public static final GerminationPlants empty = new GerminationPlants("");
	...
	public GerminationPlants() {id = nextID();list[id] = this;}

	/**It is not recommended to use this method.**/@Deprecated
	public GerminationPlants(int id) {checkID(this, id);this.id = id;list[id] = this;}
	...
	private static void checkID(GerminationPlants gp, int id) {
		if (list[id] != null)
			throw new IllegalArgumentException("Duplicate id: " + id + " in " + gp.getClass() + ".");
	}
