...
public class Orange {
	...
	public static GerminationPlants tree_orange = new GerminationPlants("tree_orange").setName("orange").setType("Tree").setTexture("orange").setPlantStats(1, 2, 3).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
