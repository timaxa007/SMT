...
public static GerminationPlants shrub_blackberry = new GerminationPlants("shrub_blackberry").setName("blackberry").setType("Shrub").setTexture("blackberry").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
