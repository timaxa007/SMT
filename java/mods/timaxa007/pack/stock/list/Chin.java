...
public static GerminationPlants crop_chin = new GerminationPlants("crop_chin").setName("chin").setType("Herbal").setTexture("chin").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
