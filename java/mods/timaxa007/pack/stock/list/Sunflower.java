...
public static GerminationPlants stem_sunflower = new GerminationPlants("stem_sunflower").setName("sunflower").setType("Stem").setTexture("sunflower").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
