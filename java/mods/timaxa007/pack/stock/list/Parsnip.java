...
public class Parsnip {
	...
	public static GerminationPlants crop_parsnip = new GerminationPlants("crop_parsnip").setName("parsnip").setType("Crop").setTexture("parsnip").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
