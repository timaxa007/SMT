...
public class Rutabaga {
	...
	public static GerminationPlants crop_rutabaga = new GerminationPlants("crop_rutabaga").setName("rutabaga").setType("Crop").setTexture("rutabaga").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
