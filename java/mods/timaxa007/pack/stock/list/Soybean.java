...
public static GerminationPlants crop_soybean = new GerminationPlants("crop_soybean").setName("soybean").setType("Crop").setTexture("soybean").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
