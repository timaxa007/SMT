...
public class Leek {
	...
	public static GerminationPlants crop_leek = new GerminationPlants("crop_leek").setName("leek").setType("Crop").setTexture("leek").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
