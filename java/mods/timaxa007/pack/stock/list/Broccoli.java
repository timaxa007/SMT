...
public class Broccoli {
	...
	public static GerminationPlants crop_broccoli = new GerminationPlants("crop_broccoli").setName("broccoli").setType("Crop").setTexture("broccoli").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
