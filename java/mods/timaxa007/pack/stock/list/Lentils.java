...
public class Lentils {
	...
	public static GerminationPlants crop_lentils = new GerminationPlants("crop_lentils").setName("lentils").setType("Herbal").setTexture("lentils").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
