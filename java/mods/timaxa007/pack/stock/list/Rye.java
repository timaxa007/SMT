...
public class Rye {
	...
	public static GerminationPlants crop_rye = new GerminationPlants("crop_rye").setName("rye").setType("Crop").setTexture("rye").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
