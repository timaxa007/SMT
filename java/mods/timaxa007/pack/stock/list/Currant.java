...
public static GerminationPlants shrub_currant = new GerminationPlants("shrub_currant").setName("currant").setType("Shrub").setTexture("currant").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
