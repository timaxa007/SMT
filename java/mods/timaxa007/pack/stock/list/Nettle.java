...
public class Nettle {
	...
	public static GerminationPlants crop_nettle = new GerminationPlants("crop_nettle").setName("nettle").setType("Herbal").setTexture("nettle").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
