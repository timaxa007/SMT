...
public static GerminationPlants tree_cherry = new GerminationPlants("tree_cherry").setName("cherry").setType("Tree").setTexture("cherry").setPlantStats(1, 2, 3).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
