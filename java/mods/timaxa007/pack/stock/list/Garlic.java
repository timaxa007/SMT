...
public class Garlic {
	...
	public static GerminationPlants crop_garlic = new GerminationPlants("crop_garlic").setName("garlic").setType("Crop").setTexture("garlic").setPlantStats(3, 2, 8).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
