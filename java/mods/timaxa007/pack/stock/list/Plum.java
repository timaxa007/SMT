...
public static GerminationPlants tree_plum = new GerminationPlants("tree_plum").setName("birch").setType("Tree").setTexture("birch").setPlantStats(1, 2, 3).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
