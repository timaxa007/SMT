...
public class Eggplant {
	...
	public static GerminationPlants herbal_eggplant = new GerminationPlants("herbal_eggplant").setName("eggplant").setType("Herbal").setTexture("eggplant").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
