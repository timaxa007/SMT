...
public static GerminationPlants crop_potato = new GerminationPlants("crop_potato").setName("potato").setType("Crop").setTexture("potato").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
