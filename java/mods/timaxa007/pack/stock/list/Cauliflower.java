...
public static GerminationPlants stem_cauliflower = new GerminationPlants("stem_cauliflower").setName("cauliflower").setType("Stem").setTexture("cauliflower").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
