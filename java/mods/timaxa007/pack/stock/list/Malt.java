...
public class Malt {
	...
	public static GerminationPlants crop_malt = new GerminationPlants("crop_malt").setName("malt").setType("Crop").setTexture("malt").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
