...
public class Squash {
	...
	public static GerminationPlants squash_squash = new GerminationPlants("squash_squash").setName("squash").setType("Squash").setTexture("squash").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
