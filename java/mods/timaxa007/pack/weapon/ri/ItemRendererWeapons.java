...
model_arms = AdvancedModelLoader.loadModel(new ResourceLocation("timaxa007", "obj/arms.obj"));
model_weapon_sniper = AdvancedModelLoader.loadModel(new ResourceLocation("timaxa007", "obj/weapon_sniper.obj"));
model_weapon_pistol = AdvancedModelLoader.loadModel(new ResourceLocation("timaxa007", "obj/weapon_pistol.obj"));
//automat_test
}
