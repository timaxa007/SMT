...
if ((f > 315.0F && f <= 360.0F) || (f > 0 && f <= 45.0F)) return 1;
if (f > 45.0F && f <= 135.0F) return 2;
if (f > 135.0F && f <= 225.0F) return 3;
if (f > 225.0F && f <= 315.0F) return 4;

if ((f > -45.0F && f <= 0.0F) || (f > -360 && f <= -315.0F)) return 1;
if (f > -315.0F && f <= -255.0F) return 2;
if (f > -255.0F && f <= -135.0F) return 3;
if (f > -135.0F && f <= -45.0F) return 4;
...
if ((f > 337.0F && f <= 360.0F) || (f > 0 && f <= 23.0F)) return 1;
if (f > 23.0F && f <= 67.0F) return 2;
if (f > 67.0F && f <= 113.0F) return 3;
if (f > 113.0F && f <= 157.0F) return 4;
if (f > 157.0F && f <= 203.0F) return 5;
if (f > 203.0F && f <= 247.0F) return 6;
if (f > 247.0F && f <= 293.0F) return 7;
if (f > 293.0F && f <= 337.0F) return 8;

if ((f > -23.0F && f <= 0.0F) || (f > -360 && f <= -337.0F)) return 1;
if (f > -337.0F && f <= -293.0F) return 2;
if (f > -293.0F && f <= -247.0F) return 3;
if (f > -247.0F && f <= -203.0F) return 4;
if (f > -203.0F && f <= -157.0F) return 5;
if (f > -157.0F && f <= -113.0F) return 6;
if (f > -113.0F && f <= -67.0F) return 7;
if (f > -67.0F && f <= -23.0F) return 8;
