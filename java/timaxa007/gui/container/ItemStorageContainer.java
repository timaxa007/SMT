...
public class ItemStorageContainer extends Container {
	...
	public ItemStorageContainer(EntityPlayer player, InventoryItemStorage inventoryStorage) {
	...
	public ItemStack slotClick(int slot, int button, int modifier, EntityPlayer player) {
		...
		System.out.println(" - slot:" + slot + ", button:" + button + ", modifier:" + modifier + ".");
		if (modifier == 2) return null;//blocked uses player's number key
