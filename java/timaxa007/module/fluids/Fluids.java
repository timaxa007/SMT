...
public class Fluids {
	...
	private static void checkTag(Fluids fluid, String tag) {
		for (Fluids fluid2 : list)
			if (fluid2 != null && fluid2.tag == tag)
				throw new IllegalArgumentException("Duplicate tag: " + tag + " in " + fluid + ".");
	}

	public static Fluids get(String tag) {
	...
	public Fluids setType(Fluids.TypeFluid type) {
		this.type = type;
		return this;
	}

	public Fluids setType(String type) {
		this.type = Fluids.TypeFluid.get(type);
		return this;
	}

	public Fluids.TypeFluid getType() {
		return type != null ? type : Fluids.TypeFluid.none;
	}
	...
	public Fluids setColor(int color) {
		color_hex = color;
		return this;
	}
	...
	public Fluids setTemperature(float f) {
		temperature = f;
		return this;
	}
	...
	public Fluids setTexture(String path) {
		texture = path;
		return this;
	}
