...
public class RenderBlockPlants extends TileEntitySpecialRenderer {
	...
	private void renderTileEntity(TileEntityPlants te, double dx, double dy, double dz, float f) {
		...
		GL11.glPopMatrix();
		//------------------------------------------------------------------------------------------------------
		if (Plants.list[plant_id].getType() == "Crop" || Plants.list[plant_id].getType() == "Mushroom") {
			GL11.glPushMatrix();
			...
			if (plant_id != 0) {
				bindTexture(new ResourceLocation("timaxa007", 
						"textures/blocks//" + 
								...
								Plants.list[plant_id].getTexture().toLowerCase() + "_" + height + ".png"));
			} else {
				bindTexture(new ResourceLocation("timaxa007", "textures/blocks//0.png"));
			}
		...
		//------------------------------------------------------------------------------------------------------
		if (Plants.list[plant_id].getType() == "Tree") {
			...
			bindTexture(new ResourceLocation("timaxa007", "textures/blocks/log_" + Plants.list[plant_id].getTexture()));
