...
import timaxa007.pack.stock.tile.TileEntityApiary;
...
public class RenderBlockApiary extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity te, double dx, double dy, double dz, float f) {
		renderTileEntity((TileEntityApiary)te, dx, dy, dz, f);
	}

	private void renderTileEntity(TileEntityApiary te, double dx, double dy, double dz, float f) {
