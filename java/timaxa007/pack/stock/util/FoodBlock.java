...
public class FoodBlock {
	...
	public FoodBlock setName(String name) {
		this.name = name;
		return this;
	}
	...
	public FoodBlock setSpeedOfEating(int speed_eating) {
	...
	public FoodBlock setFoodStat(int food_level, float saturation) {
	...
	public FoodBlock setDrinkStat(int drink_level, float quenching) {
	...
	public FoodBlock setNutriment(int food_level, float saturation, int drink_level, float quenching) {
		this.food_level = food_level;
		this.saturation = saturation;
		this.drink_level = drink_level;
		this.quenching = quenching;
	...
	public FoodBlock setNutriment(int food_level, float saturation, int drink_level, float quenching, int speed_eating) {
		this.food_level = food_level;
		this.saturation = saturation;
		this.drink_level = drink_level;
		this.quenching = quenching;
