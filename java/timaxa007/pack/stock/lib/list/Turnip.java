...
public class Turnip {
	...
	public static GerminationPlants crop_turnip = new GerminationPlants("crop_turnip").setName("turnip").setType("Crop").setTexture("turnip").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
