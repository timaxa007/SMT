...
public class Pear {
	...
	public static GerminationPlants tree_pear = new GerminationPlants("tree_pear").setName("pear").setType("Tree").setTexture("pear").setPlantStats(1, 2, 3).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
