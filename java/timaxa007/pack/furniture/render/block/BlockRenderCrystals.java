...
import timaxa007.pack.furniture.tile.TileEntityCrystals;
...
public class BlockRenderCrystals extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity te, double dx, double dy, double dz, float f) {
		renderTileEntity((TileEntityCrystals)te, dx, dy, dz, f);
	}

	private void renderTileEntity(TileEntityCrystals te, double dx, double dy, double dz, float f) {
