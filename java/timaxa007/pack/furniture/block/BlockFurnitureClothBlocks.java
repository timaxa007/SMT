...
import timaxa007.pack.furniture.tile.TileEntityFurnitureClothBlocks;
...
public class BlockFurnitureClothBlocks extends ModifiedBlock implements ITileEntityProvider {
	...
	public TileEntity createNewTileEntity(World world, int meta) {
		return new TileEntityFurnitureClothBlocks(world);
	}
	/*
