...
import timaxa007.pack.furniture.lib.AddBlockRock;
...
public class BlockRockBlocks extends ModifiedBlock implements ITileEntityProvider {
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack is) {
		...
		if (te != null && te instanceof TileEntityRockBlocks && nbt != null) {
