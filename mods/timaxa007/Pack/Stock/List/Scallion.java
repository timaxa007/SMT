...
public static GerminationPlants crop_scallion = new GerminationPlants("crop_scallion").setName("scallion").setType("Crop").setTexture("scallion").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
