...
public static GerminationPlants crop_sugarcane = new GerminationPlants("crop_sugarcane").setName("sugarcane").setType("Crop").setTexture("sugarcane").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
