...
if (weapon_list[i] == null) {return i;}
}
return 0;
}
...
public WeaponFor setName(String str) {name = str;return this;}
public String getName() {return name == null ? "unnamed" : name;}
public String getLocalizedName() {return StatCollector.translateToLocal("weapon." + getName() + ".name");}

public WeaponFor setType(String str) {type = str;return this;}
...
public WeaponFor setColors(int i) {color_hex1 = i;color_hex2 = i;return this;}
public WeaponFor setColors(int i1, int i2) {color_hex1 = i1;color_hex2 = i2;return this;}

public WeaponFor setColor1(int i) {color_hex1 = i;return this;}
public int getColor1() {return color_hex1 == 0 ? 0xFFFFFF : color_hex1;}

public WeaponFor setColor2(int i) {color_hex2 = i;return this;}
...
public WeaponFor setTemperature(float f) {temperature = f;return this;}
public float getTemperature() {return temperature == 0 ? 0.0F : temperature;}

public WeaponFor setTemperatureMin(float f) {temperature_min = f;return this;}
public float getTemperatureMin() {return temperature_min == 0 ? 0.0F : temperature_min;}

public WeaponFor setTemperatureMax(float f) {temperature_max = f;return this;}
public float getTemperatureMax() {return temperature_max == 0 ? 0.0F : temperature_max;}

public WeaponFor setTextures(String str) {texture1Name = str;texture2Name = str + "_overlay";return this;}
public WeaponFor setTextures(String str1, String str2) {texture1Name = str1;texture2Name = str2;return this;}

public WeaponFor setTexture1(String str) {texture1Name = str;return this;}
public String getTexture1() {return texture1Name == null ? getName() : texture1Name;}

public WeaponFor setTexture2Name(String str) {texture2Name = str;return this;}
public String getTexture2() {return texture2Name == null ? getTexture1() : texture2Name;}

public WeaponFor setAmmo(MagazineFor magazines) {ammo = null;magazine = magazines;return this;}
public WeaponFor setAmmo(AmmoFor ammos) {ammo = ammos;magazine = null;return this;}

public AmmoFor getAmmo() {return ammo;}
public MagazineFor getMagazine() {return magazine;}

public WeaponFor setSizeAmmo(int i) {size_ammo = i;return this;}
public int getSizeAmmo() {return size_ammo;}
