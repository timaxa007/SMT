...
public EntityBullet(World world, EntityLivingBase entityLive, EntityLivingBase EntityLive2, float par4, float par5) {
super(world);
renderDistanceWeight = 10.0D;
shootingEntity = entityLive;

if (entityLive instanceof EntityPlayer) {canBePickedUp = 1;}

posY = entityLive.posY + (double)entityLive.getEyeHeight() - 0.10000000149011612D;
double d0 = EntityLive2.posX - entityLive.posX;
double d1 = EntityLive2.boundingBox.minY + (double)(EntityLive2.height / 3.0F) - posY;
double d2 = EntityLive2.posZ - entityLive.posZ;
...
double d4 = d0 / d3;
double d5 = d2 / d3;
setLocationAndAngles(entityLive.posX + d4, posY, entityLive.posZ + d5, f2, f3);
yOffset = 0.0F;
...
public EntityBullet(World world, EntityLivingBase entityLive, float par3) {
super(world);
renderDistanceWeight = 10.0D;
shootingEntity = entityLive;
...
setSize(0.5F, 0.5F);
setLocationAndAngles(entityLive.posX, entityLive.posY + (double)entityLive.getEyeHeight(), entityLive.posZ, entityLive.rotationYaw, entityLive.rotationPitch);
...
damagesource = new EntityDamageSourceIndirect("arrow", this, entity).setProjectile();
} else {
