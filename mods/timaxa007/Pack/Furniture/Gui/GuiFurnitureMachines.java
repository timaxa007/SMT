...
public class GuiFurnitureMachines extends GuiContainer {

private TEFurnitureMachines te;

public GuiFurnitureMachines(EntityPlayer player, TEFurnitureMachines te2) {
super(new ContainerFurnitureMachines(player, te2));
te=te2;
}
