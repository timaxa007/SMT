...
public class BlockStoneColona3Colors extends Block{
@SideOnly(Side.CLIENT) private Icon[] iconArray;
@SideOnly(Side.CLIENT) private Icon[] iconTop;
public static final String[] colona3Types=new String[]{"LightGreen", "Magenta", "Orange", "Pink"};

public BlockStoneColona3Colors(int id) {
super(id, Material.rock);
setCreativeTab(PackFurniture.proxy.tabFurniturePack);
setStepSound(soundStoneFootstep);
setTextureName("planks_oak");
setUnlocalizedName("StoneColona3Colors");
}
...
ret.add(new ItemStack(PackFurniture.proxy.item_brick_colors.itemID, 3, metadata+8));
return ret;
}

@SideOnly(Side.CLIENT)
public void registerIcons(IconRegister ir) {
iconArray=new Icon[colona3Types.length];
iconTop=new Icon[colona3Types.length];
for(byte i=0;i<iconArray.length;++i) {
iconArray[i] = ir.registerIcon("timaxa007:" + "stone/" + "stone_colona_" + GetColors.getNameColors[i + 8]);
iconTop[i] = ir.registerIcon("timaxa007:" + "stone/" + "stone_colona_" + GetColors.getNameColors[i + 8] + "_top");
}
}
