...
public BlockLampsInvert(int id, boolean par2) {
...
par1World.setBlock(par2, par3, par4, PackFurniture.proxy.block_lamps_off_invert.blockID, j, 2);
}
}
...
for(byte j=0;j<16;++j) {
if(getDamageValue(par1World, par2, par3, par4)==j) {
par1World.setBlock(par2, par3, par4, PackFurniture.proxy.block_lamps_on_invert.blockID, j, 2);
}
}
...
ret.add(new ItemStack(PackFurniture.proxy.block_lamps_on_invert.blockID, 1, metadata));
return ret;
}
