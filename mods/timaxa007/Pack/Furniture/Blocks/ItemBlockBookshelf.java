...
public ItemBlockBookshelf(int id) {
super(id);
this.setMaxDamage(0);
...
wrd.setBlock(x, y, z, PackFurniture.proxy.block_bookshelf.blockID, 0, 3);
...
if(tag!=null) {
((TEBookshelf)te).setType(tag.getInteger("Type"));;
}else{
((TEBookshelf)te).setType(0);
}
}
return true;
}
