...
public class BlockModelLampsOff extends BlockContainer{
@SideOnly(Side.CLIENT) private Icon[] iconArray;
private final boolean powered;

public BlockModelLampsOff(int id) {
...
setUnlocalizedName("BlockModelLampsOff");
}
...
@Override
public TileEntity createNewTileEntity(World world) {return new TELampsOff();}
...
par1World.setBlock(par2, par3, par4, PackFurniture.proxy.block_model_lamps_on.blockID, j, 2);
}
}
...
for(byte j=0;j<16;++j) {
if(getDamageValue(par1World, par2, par3, par4)==j) {
par1World.setBlock(par2, par3, par4, PackFurniture.proxy.block_model_lamps_off.blockID, j, 2);
}
}
...
ret.add(new ItemStack(PackFurniture.proxy.block_model_lamps_off.blockID, 1, metadata));
return ret;
}
