...
public ItemForTechno(String str) {
checkNameID(str);//OFF
item_list[nextID()] = this;
itemID = nextID();
nameID = str;
...
public ItemForTechno setName(String str) {name = str;return this;}
...
public ItemForTechno setType(String str) {type = str;return this;}
...
public ItemForTechno setColors(int i) {color_hex1 = i;color_hex2 = i;return this;}
public ItemForTechno setColors(int i1, int i2) {color_hex1 = i1;color_hex2 = i2;return this;}

public ItemForTechno setColor1(int i) {color_hex1 = i;return this;}
public int getColor1() {return color_hex1 == 0 ? 0xFFFFFF : color_hex1;}

public ItemForTechno setColor2(int i) {color_hex2 = i;return this;}
public int getColor2() {return color_hex2 == 0 ? 0xFFFFFF : color_hex2;}

public ItemForTechno setTextures(String str) {texture1Name = str;texture2Name = str + "_overlay";return this;}
public ItemForTechno setTextures(String str1, String str2) {texture1Name = str1;texture2Name = str2;return this;}

public ItemForTechno setTexture1(String str) {texture1Name = str;return this;}
public String getTexture1() {return texture1Name == null ? getName() : texture1Name;}

public ItemForTechno setTexture2(String str) {texture2Name = str;return this;}
