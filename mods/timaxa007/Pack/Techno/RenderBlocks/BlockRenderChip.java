package mods.timaxa007.Pack.Techno.RenderBlocks;
...
this.renderTE((TEChip)tileEntity, d1, d2, d3, f);
}

public void renderTE(TEChip tileEntity, double d1, double d2, double d3, float f) {
