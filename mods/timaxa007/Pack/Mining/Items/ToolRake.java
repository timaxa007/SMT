...
public class ToolRake extends Item{
...
this.setUnlocalizedName("tool.rake");
}
...
list.add(Option.getText("Type")+": Tool / Rake.");
}else{
...
ItemStack is=new ItemStack(PackMining.proxy.toolRake);
...
this.theIcon=ir.registerIcon("timaxa007:"+"tool/"+"rake_overlay");
this.iconArray=ir.registerIcon("timaxa007:"+"tool/"+"rakeHandle");
}
