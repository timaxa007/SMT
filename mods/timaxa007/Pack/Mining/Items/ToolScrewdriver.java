...
this.setUnlocalizedName("tool.screwdriver");
}
...
return material!=Material.plants&&material!=Material.coral?1.0F:1.5F;
}
}
...
list.add(Option.getText("Type")+": Tool / Screwdriver.");
}else{
...
ItemStack is=new ItemStack(PackMining.proxy.toolScrewdriver);
...
this.theIcon=ir.registerIcon("timaxa007:"+"tool/"+"screwdriverHead_overlay");
this.iconArray=ir.registerIcon("timaxa007:"+"tool/"+"screwdriverHandle_overlay");
}
