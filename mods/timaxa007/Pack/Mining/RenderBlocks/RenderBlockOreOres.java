package mods.timaxa007.Pack.Mining.RenderBlocks;
...
render((TEOreOres)te, dx, dy, dz, f);
}

private void render(TEOreOres te, double dx, double dy, double dz, float f) {
int typ = 0;
//int clr = 0x00AAFF;
//int clr = 0xAA9999;
//int clr = 0x88FF00;
...
int i = (int)(te.worldObj.getLightBrightness(te.xCoord, te.yCoord, te.zCoord) * 255.0F);
