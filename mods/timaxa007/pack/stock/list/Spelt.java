...
public static GerminationPlants crop_spelt = new GerminationPlants("crop_spelt").setName("spelt").setType("Crop").setTexture("spelt").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
