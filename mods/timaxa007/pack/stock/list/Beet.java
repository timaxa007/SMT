...
public static GerminationPlants crop_beet = new GerminationPlants("crop_beet").setName("beet").setType("Crop").setTexture("beet").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
