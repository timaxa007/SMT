...
public static GerminationPlants tree_lemon = new GerminationPlants("tree_lemon").setName("lemon").setType("Tree").setTexture("lemon").setPlantStats(1, 2, 3).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
