...
public static GerminationPlants crop_buckwheat = new GerminationPlants("crop_buckwheat").setName("buckwheat").setType("Crop").setTexture("buckwheat").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
