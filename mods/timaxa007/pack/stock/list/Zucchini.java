...
public static GerminationPlants squash_zucchini = new GerminationPlants("squash_zucchini").setName("zucchini").setType("Squash").setTexture("zucchini").setPlantStats(3, 2, 1).setTemperatures(30.0F, 0.0F, 60.0F).setHumidity(30.0F, 0.0F, 60.0F);
