...
public static final GerminationPlants plant_empty = new GerminationPlants(0);
...
for (int i = 0; i < plant_list.length; i++) {
if (str.equalsIgnoreCase(plant_list[i].tagID)) {
return true;
}
}
return false;
...
for (int i = 0; i < plant_list.length; i++) {
if (str.equalsIgnoreCase(plant_list[i].tagID)) {return i;}
}
return 0;
}
...
for (int i = 0; i < plant_list.length; i++) {
if (plant_list[i] != null && plant_list[i].tagID == str) {
...
/*
public GerminationPlants setColor(int i) {color_hex = i;return this;}
...
public GerminationPlants setGrowth(int i) {growth = i;return this;}
public int getGrowth() {return growth == 0 ? 0 : growth;}

public GerminationPlants setFertility(int i) {fertility = i;return this;}
public int getFertility() {return fertility == 0 ? 0 : fertility;}

public GerminationPlants setResistance(int i) {resistance = i;return this;}
public int getResistance() {return resistance == 0 ? 0 : resistance;}
...
public GerminationPlants setTemperature(float f) {temperature = f;return this;}
public float getTemperature() {return temperature == 0 ? 0.0F : temperature;}

public GerminationPlants setTemperatureMin(float f) {temperature_min = f;return this;}
public float getTemperatureMin() {return temperature_min == 0 ? 0.0F : temperature_min;}

public GerminationPlants setTemperatureMax(float f) {temperature_max = f;return this;}
...
public GerminationPlants setHumidity(float f) {humidity = f;return this;}
public float getHumidity() {return humidity == 0 ? 0.0F : humidity;}

public GerminationPlants setHumidityMin(float f) {humidity_min = f;return this;}
public float getHumidityMin() {return humidity_min == 0 ? 0.0F : humidity_min;}

public GerminationPlants setHumidityMax(float f) {humidity_max = f;return this;}
public float getHumidityMax() {return humidity_max == 0 ? 0.0F : humidity_max;}

public GerminationPlants setTexture(String str) {texture = str;return this;}
