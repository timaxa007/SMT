...
player.addPotionEffect(new PotionEffect(Potion.waterBreathing.id, 20*10, 3));
	...
	player.dropPlayerItem(new ItemStack(PackStock.proxy.item_medicals, 1, 160));
	}else{
	player.dropPlayerItem(new ItemStack(PackStock.proxy.item_medicals, 1, 159));
	}
...
player.addPotionEffect(new PotionEffect(Potion.waterBreathing.id, 4000, 1));
	...
	player.dropPlayerItem(new ItemStack(PackStock.proxy.item_medicals, 1, 170));
	}else{
	player.dropPlayerItem(new ItemStack(PackStock.proxy.item_medicals, 1, 169));
	}
...
player.addPotionEffect(new PotionEffect(Potion.waterBreathing.id, 2000, 5));
	...
	player.dropPlayerItem(new ItemStack(PackStock.proxy.item_medicals, 1, 180));
	}else{
	player.dropPlayerItem(new ItemStack(PackStock.proxy.item_medicals, 1, 179));
	}
}
...
player.addPotionEffect(new PotionEffect(Potion.waterBreathing.id, 4000, 5));
	...
	player.dropPlayerItem(new ItemStack(PackStock.proxy.item_medicals, 1, 190));
	}else{
	player.dropPlayerItem(new ItemStack(PackStock.proxy.item_medicals, 1, 189));
	}
