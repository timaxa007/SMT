...
@Mod (modid = PackInfo.MODID, name = PackInfo.MODNAME, version = PackInfo.VERSION, dependencies = "required-after:05magicpack")
...
@Instance(PackInfo.MODID) public static PackWeapon instance;
