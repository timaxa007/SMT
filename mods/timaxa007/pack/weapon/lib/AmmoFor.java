...
//@SideOnly(Side.CLIENT) protected IIcon icon_ammo;
...
for (int i = 0; i < ammo_list.length; i++) {
if (str.equalsIgnoreCase(ammo_list[i].tagID)) {return i;}
}
return 0;
}
...
public AmmoFor setName(String str) {name = str;return this;}
public String getName() {return name == null ? "unnamed" : name;}
public String getLocalizedName() {return StatCollector.translateToLocal("ammo." + getName() + ".name");}

public AmmoFor setType(String str) {type = str;return this;}
...
public AmmoFor setColors(int i) {color_hex1 = i;color_hex2 = i;return this;}
public AmmoFor setColors(int i1, int i2) {color_hex1 = i1;color_hex2 = i2;return this;}

public AmmoFor setColor1(int i) {color_hex1 = i;return this;}
public int getColor1() {return color_hex1 == 0 ? 0xFFFFFF : color_hex1;}

public AmmoFor setColor2(int i) {color_hex2 = i;return this;}
...
public AmmoFor setTemperature(float f) {temperature = f;return this;}
public float getTemperature() {return temperature == 0 ? 0.0F : temperature;}

public AmmoFor setTemperatureMin(float f) {temperature_min = f;return this;}
public float getTemperatureMin() {return temperature_min == 0 ? 0.0F : temperature_min;}

public AmmoFor setTemperatureMax(float f) {temperature_max = f;return this;}
public float getTemperatureMax() {return temperature_max == 0 ? 0.0F : temperature_max;}

public AmmoFor setTextures(String str) {texture1Name = str;texture2Name = str + "_overlay";return this;}
public AmmoFor setTextures(String str1, String str2) {texture1Name = str1;texture2Name = str2;return this;}

public AmmoFor setTexture1(String str) {texture1Name = str;return this;}
public String getTexture1() {return texture1Name == null ? getName() : texture1Name;}

public AmmoFor setTexture2(String str) {texture2Name = str;return this;}
public String getTexture2() {return texture2Name == null ? getTexture1() : texture2Name;}

/*
@SideOnly(Side.CLIENT)
public void registerIcons(IIconRegister ir) {
icon_ammo = ir.registerIcon("timaxa007:" + getTextureName());
}
*/
}
