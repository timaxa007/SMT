...
this.setUnlocalizedName("tool.hoe");
}
...
list.add(Option.getText("Type")+": Tool / Hoe.");
}else{
...
ItemStack is=new ItemStack(PackMining.proxy.toolHoe);
...
this.theIcon=ir.registerIcon("timaxa007:"+"tool/"+"hoeMetals_overlay");
this.iconArray=ir.registerIcon("timaxa007:"+"tool/"+"hoeHandle");
}
