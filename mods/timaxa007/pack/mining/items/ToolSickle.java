...
this.setUnlocalizedName("tool.sickle");
}
...
list.add(Option.getText("Type")+": Tool / Sickle.");
}else{
...
ItemStack is=new ItemStack(PackMining.proxy.toolSickle);
...
this.theIcon=ir.registerIcon("timaxa007:"+"tool/"+"sickleMetals_overlay");
this.iconArray=ir.registerIcon("timaxa007:"+"tool/"+"sickleHandle");
}
