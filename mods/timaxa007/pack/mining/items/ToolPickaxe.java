...
this.setUnlocalizedName("tool.pickaxe");
}
...
ItemStack is=new ItemStack(PackMining.proxy.toolPickaxe);
...
this.theIIcon=ir.registerIcon("timaxa007:"+"tool/"+"pickaxeMetals_overlay");
this.iconArray=ir.registerIcon("timaxa007:"+"tool/"+"pickaxeHandle");
}
