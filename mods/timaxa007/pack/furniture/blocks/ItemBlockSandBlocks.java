...
public class ItemBlockSandBlocks extends ItemBlock {

public ItemBlockSandBlocks(Block id) {
super(id);
}
...
return super.getUnlocalizedName() + "." + BlockSandBlocks.type_block[tag.getByte("SubID")];
}
