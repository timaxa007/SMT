...
public class BlockStoneColona4Colors extends Block{
@SideOnly(Side.CLIENT) private Icon[] iconArray;
@SideOnly(Side.CLIENT) private Icon[] iconTop;
public static final String[] colona4Types=new String[]{"Purple", "Red", "White", "Yellow"};

public BlockStoneColona4Colors(int id) {
super(id, Material.rock);
setCreativeTab(PackFurniture.proxy.tabFurniturePack);
setStepSound(soundStoneFootstep);
setTextureName("planks_oak");
setUnlocalizedName("StoneColona4Colors");
}
...
ret.add(new ItemStack(PackFurniture.proxy.item_brick_colors.itemID, 3, metadata+12));
return ret;
}

@SideOnly(Side.CLIENT)
public void registerIcons(IconRegister ir) {
iconArray=new Icon[colona4Types.length];
iconTop=new Icon[colona4Types.length];
for(byte i=0;i<iconArray.length;++i) {
iconArray[i] = ir.registerIcon("timaxa007:" + "stone/" + "stone_colona_" + GetColors.getNameColors[i + 12]);
iconTop[i] = ir.registerIcon("timaxa007:" + "stone/" + "stone_colona_" + GetColors.getNameColors[i + 12] + "_top");
}
}
