...
public BlockModelLampsOn(int id) {
...
setUnlocalizedName("BlockModelLampsOn");
}

@SideOnly(Side.CLIENT)
public Icon getIcon(int p1, int p2) {
...
@Override
public TileEntity createNewTileEntity(World wrd) {return new TELampsOn();}
