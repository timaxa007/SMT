...
public class ItemBlockWoodBlocks extends ItemBlock {

public ItemBlockWoodBlocks(Block id) {
super(id);
}
...
return super.getUnlocalizedName() + "." + BlockWoodBlocks.type_block[tag.getByte("SubID")];
}
