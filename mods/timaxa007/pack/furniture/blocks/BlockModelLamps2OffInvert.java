...
public class BlockModelLamps2OffInvert extends BlockContainer{
@SideOnly(Side.CLIENT) private Icon[] iconArray;
private final boolean powered;

public BlockModelLamps2OffInvert(int id) {
...
setUnlocalizedName("BlockModelLamps2OffInvert");
}
...
@Override
public TileEntity createNewTileEntity(World world) {return new TELamps2Off();}
