...
public class GuiMagicMachines extends GuiContainer{

private TEMagicMachines te;

public GuiMagicMachines(EntityPlayer player, TEMagicMachines te2) {
super(new ContainerMagicMachines(player, te2));
te=te2;
}
