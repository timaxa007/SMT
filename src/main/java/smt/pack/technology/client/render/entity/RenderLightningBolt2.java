package smt.pack.technology.client.render.entity;
...
import smt.pack.technology.entity.EntityLightningBolt2;
...
public class RenderLightningBolt2 extends Render {
	 ...
	 */
	public void doRender(EntityLightningBolt2 p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float yaw, float parTick) {
		...
		for (int k1 = 0; k1 < 4; ++k1) {
			...
			for (int j = 0; j < 3; ++j) {
				...
				for (int i1 = k; i1 >= l; --i1) {
					...
					//float f2 = 0.5F;
					tessellator.setColorRGBA_F(0.05F, 0.576F, 0.05F, 0.35F);
	 ...
	 */
	public ResourceLocation getEntityTexture(EntityLightningBolt2 p_110775_1_) {
		return null;
	}
	...
	public ResourceLocation getEntityTexture(Entity p_110775_1_) {
		return this.getEntityTexture((EntityLightningBolt2)p_110775_1_);
	}
	 ...
	 * double d2, float f, float f1). But JAD is pre 1.5 so doesn't do that.
	 */
	public void doRender(Entity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float yaw, float parTick) {
		this.doRender((EntityLightningBolt2)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, yaw, parTick);
	}
